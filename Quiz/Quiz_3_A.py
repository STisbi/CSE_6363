...
class PotassiumMeans:
    ...
    def Run_K_Means(self):
        ...
        self.score = kmeans.score(passed_in_data)
    ...
    def Print_Score(self):
        print("Object Function Value:", self.Get_Score())
...
def main():
    ...
    pot_means = PotassiumMeans(data_files[1], clusters=26)
